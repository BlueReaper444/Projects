...
public class EndGameState extends State{
    ...
    public void Draw(Graphics graphics) {
        ...
        StringDrawer.StringDraw(graphics, "You died ", handler.getGame().getWidth()/3, handler.getGame().getHeight()/4, Color.white, Assets.font72);
        StringDrawer.StringDraw(graphics, "Final score: "+handler.getWorld().getEntityManager().getPlayer().getScore(), handler.getGame().getWidth()/3, handler.getGame().getHeight()/4 + 78, Color.white, Assets.font72);
