...
public class smallProjectile extends Projectile{
    ...
    public smallProjectile(Handler handler, float x, float y, boolean moveType, short direction,int damage,boolean mainplayer) {
        super(handler, x, y, 20, 20,mainplayer);
        ...
        general = new Animations(90, Assets.blue_flame);
    }
    @Override
