...
public class MaxHealthPotion extends StaticEntity {
    public MaxHealthPotion(Handler handler, float x, float y) {
    ...
    public void GetKilled()
    {
        ...
        handler.getWorld().getEntityManager().getPlayer().getPlayerInventoryAndStats().addItem(Item.max_health_potion.createNew());
    }
    ...
    public void Draw(Graphics graphics) {
        graphics.drawImage(Assets.max_health_potion, (int)(x- handler.getGameCamera().getxOffset()),  (int)(y- handler.getGameCamera().getyOffset()), width, height, null);
